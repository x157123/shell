...
screen -dmS chrome bash -c "export DISPLAY=:${window}; google-chrome --remote-debugging-port=9515 --no-first-run --user-data-dir=/tmp/nexus/userData/9515 --load-extension=/home/ubuntu/extensions/chrome-cloud"
