...
try:
    ...
    cred = credential.Credential("x", "x")
    ...
    # 实例化要请求产品的client对象,clientProfile是可选的   ap-singapore（新加坡） ap-seoul（首尔）	ap-tokyo（东京）
    client = lighthouse_client.LighthouseClient(cred, "ap-singapore", clientProfile)


    instance_list = ['lhins-1nwuj0z1', 'lhins-m97eu5ux', 'lhins-nouvpn0r',
    ...
    for instance_id in instance_list:
        ...
        # 返回的resp是一个ResetInstancesPasswordResponse的实例，与请求对象对应
